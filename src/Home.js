  ...
  return <main><a className="skip-link" href="#works">Skip to selected work</a><div className="paper-shell">
    ...
    <section className="hero section-rule">
      ...
      <div className="hero-grid"><div className="hero-copy">
        ...
        <div className="news-ticker"><div><strong>09</strong><span>Selected works</span></div><div><strong>Web3</strong><span>Primary beat</span></div><div><strong>Global</strong><span>Remote-ready</span></div><div><strong>Clear</strong><span>No jargon for jargon’s sake</span></div></div>
