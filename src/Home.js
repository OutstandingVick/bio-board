...
export default function Home() {
  return <main><a className="skip-link" href="#works">Skip to selected work</a><div className="paper-shell">
    ...
    <section className="hero section-rule">
      ...
      </div><figure className="hero-portrait"><img src={`${process.env.PUBLIC_URL}/img/outstandingvick-laptop.jpg`} alt="Outstandingvick, writer and researcher" decoding="async" /><figcaption>Pictured: the writer, somewhere between a protocol deep-dive and a deadline.</figcaption></figure></div>
